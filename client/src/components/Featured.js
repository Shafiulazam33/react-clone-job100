    ...
    <div className="featured-wrapper">
      <div className="featured">
        ...
        <ul className="featured-ul">
          <li>
            Your job offer will be featured on the <b>frontpage</b> for 30 days
          </li>
          <li>
            Your job offer will stay on top of<b>search results</b> for 30 days
          </li>
          <li>
            Your job offer will appear in our <b>newsletter</b>
          </li>
        </ul>
        <StripeCheckout
          token={onToken}
