  ...
  const submitHandler = (event) => {
    ...
    Axios.post(RouteOptions(), state)
      .then((res) => {
        ...
        history.push("/adv", { myParam: res.data.jobpost._id });
      })
      .catch((error) => {
    ...
    <>
      <div className="company-wrapper">
        <div className="company-type">
          {" "}
          <p className="title">Select an existing company</p>
          <Dropdown
              ...
              <div className="job">
                <div className="horizontal-line">
                  <div className="logo-wrapper">
                    ...
                    <span className="job-logo">
                      <img src="/images/iconfinder_Sed-05_2232591.png" />a
                    </span>
                    <span>Job</span>
                  </div>
                </div>
                <div className="layer1">
                  ...
                  <div className="location">
                    ...
                    <div className="ui input">
                      <input
                        placeholder="Pick a location e.g. Tokyo1"
                ...
                <div className="layer2">
                  ...
                  <div className="apply">
                    <p className="title">Apply url or email</p>
                    <div className="ui input">
                      <input
                        name="apply_link"
                        onChange={myChangeHandler}
    ...
    return (
      <div className="advertise-wrapper">
        ...
        <p>
          ...
          <Link className="ui large primary button" to={`/Featured/${job_id}`}>
