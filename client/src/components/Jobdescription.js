    ...
    return (
      <div className="job-description">
        <div className="job-description-layer1">
          <h1>
            {state.job_title} position at {state.company_name}
          </h1>
          <p className="type-salary">
            <Icon name="info circle"></Icon>
            <span>{state.job_type}</span>
            <span className="job-slary">
              <Icon name="money bill alternate outline"></Icon> {state.salary}
            </span>
          </p>
          <p className="location-remote">
        ...
        <div className="job-description-layer3">
          <div className="logo-website">
            ...
            <div>
              ...
              <div
                dangerouslySetInnerHTML={{ __html: state.short_description }}
              />
            </div>
          </div>
        </div>
