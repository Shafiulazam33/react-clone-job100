      ...
      <ul className="jobs-list">
        {data
          ? data.map((value, index) => {
              let { company_name, logo_url } = com.find(
                (val) => val._id === value.company
              );
              return (
                <>
                  <li
                    key={value._id}
                    className="company-post-wrapper"
                    onClick={(e) => {
                      e.stopPropagation();
                      history.push(`/job/${value._id}`);
                    }}
                  >
                    <div className="company-post">
                      ...
                      <div className="job-details">
                        ...
                        <div className="listed-edit-promote">
                          ...
                          >
                            <Checkbox
                              checked={funcCh(value.islisted)}
                              onClick={(e) => {
                                e.stopPropagation();
                                funcList(value._id, null);
                              }}
                              toggle
                              onChange={funcCheckbox}
                            />
                            <p>Listed</p>
                          </div>
                          <Link
