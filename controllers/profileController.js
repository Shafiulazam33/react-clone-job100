...
module.exports = {
  ...
  updatePassword(req, res) {
    ...
    let validate = passwordValidator({
      currentPassword,
      newPassword,
      confirmPassword,
    });
  ...
  updateCompany(req, res) {
    ...
    Company.findOneAndUpdate(
      { _id },
      { $set: { company_name, website, logo_url, short_description } },
      { new: true }
    )
      .exec()
      .then((result) => {
